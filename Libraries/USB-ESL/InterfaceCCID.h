...
#ifndef CCID_MAX_SUPPORTED_SLOT
#define CCID_MAX_SUPPORTED_SLOT 4
#endif
...
#define CCID_MAX_SLOT_STATE_SIZE    ((CCID_MAX_SUPPORTED_SLOT + 3) / 4)
...
typedef struct {
    ...
    uint8_t bmSlotICCState[CCID_MAX_SLOT_STATE_SIZE];
...
struct InterfaceCCIDStruct_s {
...
#ifdef CCID_SUPPORT_NOTIFICATION
    bool (*Notify)(InterfaceCCIDStruct* self, uint8_t bSlot, bool isPresent);
#endif // CCID_SUPPORT_NOTIFICATION
...
#ifdef CCID_SUPPORT_NOTIFICATION
    CCIDNotificationStruct Notification;
#endif // CCID_SUPPORT_NOTIFICATION
    ...
    union {
        struct {
            ...
            CCIDCardStatusEnum bmICCStatus : 2;
        };
        uint8_t State;
    } Slot[CCID_MAX_SUPPORTED_SLOT];
};
