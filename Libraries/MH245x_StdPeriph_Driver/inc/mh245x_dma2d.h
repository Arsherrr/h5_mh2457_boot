...
#ifndef __PERIPH_DMA2D_H__
#define __PERIPH_DMA2D_H__
...
#define DMA2D_OPFCCR_ROT_Pos	   (9U)
#define DMA2D_OPFCCR_ROT_Msk	   (0x3UL << DMA2D_OPFCCR_ROT_Pos)
#define DMA2D_OPFCCR_ROT		   DMA2D_OPFCCR_ROT_Msk
#define DMA2D_OPFCCR_ROT_0		   (0x1UL << DMA2D_OPFCCR_ROT_Pos)
#define DMA2D_OPFCCR_ROT_1		   (0x2UL << DMA2D_OPFCCR_ROT_Pos)
...
typedef struct
{
  uint32_t Mode;                 /*!< Specifies the DMA2D transfer mode.
                                      - This parameter can be one value of @ref DMA2D_EC_MODE.

                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetMode(). */

  uint32_t ColorMode;            /*!< Specifies the color format of the output image.
                                      - This parameter can be one value of @ref DMA2D_EC_OUTPUT_COLOR_MODE.

                                      This parameter can be modified afterwards using,
                                      unitary function @ref DMA2D_SetOutputColorMode(). */
  ...
  uint32_t OutputBlue;           /*!< Specifies the Blue value of the output image.
                                      ...
                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetOutputColor() or configuration
                                      function @ref DMA2D_ConfigOutputColor(). */
  ...
  uint32_t OutputAlpha;          /*!< Specifies the Alpha channel of the output image.
                                      ...
                                      This parameter can be modified afterwards using,
                                      unitary function @ref DMA2D_SetOutputColor() or configuration
                                      function @ref DMA2D_ConfigOutputColor(). */
  ...
  uint32_t OutputMemoryAddress;  /*!< Specifies the memory address.
                                      ...
                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetOutputMemAddr(). */

  uint32_t OutputSwapMode;             /*!< Specifies the output swap mode color format of the output image.
                                      - This parameter can be one value of @ref DMA2D_EC_OUTPUT_SWAP_MODE.

                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetOutputSwapMode(). */

  uint32_t LineOffsetMode;       /*!< Specifies the output line offset mode.
                                      - This parameter can be one value of @ref DMA2D_EC_LINE_OFFSET_MODE.

                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetLineOffsetMode(). */

  uint32_t LineOffset;           /*!< Specifies the output line offset value.
                                      - This parameter must be a number between Min_Data = 0x0000 and Max_Data = 0xFFFF.

                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetLineOffset(). */
  ...
  uint32_t NbrOfLines;           /*!< Specifies the number of lines of the area to be transferred.
                                      ...
                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetNbrOfLines(). */

  uint32_t NbrOfPixelsPerLines;  /*!< Specifies the number of pixels per lines of the area to be transferred.
                                      - This parameter must be a number between Min_Data = 0x0000 and Max_Data = 0x3FFF.

                                      This parameter can be modified afterwards using,
                                      unitary function @ref DMA2D_SetNbrOfPixelsPerLines(). */

  uint32_t AlphaInversionMode;   /*!< Specifies the output alpha inversion mode.
                                      - This parameter can be one value of @ref DMA2D_EC_ALPHA_INVERSION.

                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetOutputAlphaInvMode(). */

  uint32_t RBSwapMode;           /*!< Specifies the output Red Blue swap mode.
                                      - This parameter can be one value of @ref DMA2D_EC_RED_BLUE_SWAP.

                                      This parameter can be modified afterwards,
                                      using unitary function @ref DMA2D_SetOutputRBSwapMode(). */
...
typedef struct
{
  uint32_t MemoryAddress;        /*!< Specifies the foreground or background memory address.
                                      ...
                                      - @ref DMA2D_FGND_SetMemAddr() for foreground layer,
                                      - @ref DMA2D_BGND_SetMemAddr() for background layer. */

  uint32_t LineOffset;           /*!< Specifies the foreground or background line offset value.
                                      - This parameter must be a number between Min_Data = 0x0000 and Max_Data = 0x3FFF.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetLineOffset() for foreground layer,
                                      - @ref DMA2D_BGND_SetLineOffset() for background layer. */

  uint32_t ColorMode;            /*!< Specifies the foreground or background color mode.
                                      - This parameter can be one value of @ref DMA2D_EC_INPUT_COLOR_MODE.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetColorMode() for foreground layer,
                                      - @ref DMA2D_BGND_SetColorMode() for background layer. */

  uint32_t CLUTColorMode;        /*!< Specifies the foreground or background CLUT color mode.
                                       - This parameter can be one value of @ref DMA2D_EC_CLUT_COLOR_MODE.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetCLUTColorMode() for foreground layer,
                                      - @ref DMA2D_BGND_SetCLUTColorMode() for background layer. */

  uint32_t CLUTSize;             /*!< Specifies the foreground or background CLUT size.
                                      - This parameter must be a number between Min_Data = 0x00 and Max_Data = 0xFF.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetCLUTSize() for foreground layer,
                                      - @ref DMA2D_BGND_SetCLUTSize() for background layer. */

  uint32_t AlphaMode;            /*!< Specifies the foreground or background alpha mode.
                                       - This parameter can be one value of @ref DMA2D_EC_ALPHA_MODE.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetAlphaMode() for foreground layer,
                                      - @ref DMA2D_BGND_SetAlphaMode() for background layer. */

  uint32_t Alpha;                /*!< Specifies the foreground or background Alpha value.
                                      - This parameter must be a number between Min_Data = 0x00 and Max_Data = 0xFF.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetAlpha() for foreground layer,
                                      - @ref DMA2D_BGND_SetAlpha() for background layer. */

  uint32_t Blue;                 /*!< Specifies the foreground or background Blue color value.
                                      - This parameter must be a number between Min_Data = 0x00 and Max_Data = 0xFF.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetBlueColor() for foreground layer,
                                      - @ref DMA2D_BGND_SetBlueColor() for background layer. */

  uint32_t Green;                /*!< Specifies the foreground or background Green color value.
                                      - This parameter must be a number between Min_Data = 0x00 and Max_Data = 0xFF.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetGreenColor() for foreground layer,
                                      - @ref DMA2D_BGND_SetGreenColor() for background layer. */

  uint32_t Red;                  /*!< Specifies the foreground or background Red color value.
                                      - This parameter must be a number between Min_Data = 0x00 and Max_Data = 0xFF.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetRedColor() for foreground layer,
                                      - @ref DMA2D_BGND_SetRedColor() for background layer. */
  ...
  uint32_t CLUTMemoryAddress;    /*!< Specifies the foreground or background CLUT memory address.
                                      ...
                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetCLUTMemAddr() for foreground layer,
                                      - @ref DMA2D_BGND_SetCLUTMemAddr() for background layer. */

  uint32_t AlphaInversionMode;   /*!< Specifies the foreground or background alpha inversion mode.
                                      - This parameter can be one value of @ref DMA2D_EC_ALPHA_INVERSION.

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetAlphaInvMode() for foreground layer,
                                      - @ref DMA2D_BGND_SetAlphaInvMode() for background layer. */

  uint32_t RBSwapMode;           /*!< Specifies the foreground or background Red Blue swap mode.
                                      This parameter can be one value of @ref DMA2D_EC_RED_BLUE_SWAP .

                                      This parameter can be modified afterwards using unitary functions
                                      - @ref DMA2D_FGND_SetRBSwapMode() for foreground layer,
                                      - @ref DMA2D_BGND_SetRBSwapMode() for background layer. */
  ...
  uint32_t ChromaSubSampling;   /*!< Configure the chroma sub-sampling mode for the YCbCr color mode
                                     ...
                                     This parameter can be modified afterwards using unitary functions
                                     - @ref DMA2D_FGND_SetChrSubSampling() for foreground layer. */
...
/** @defgroup DMA2D_EC_GET_FLAG Get Flags Defines
  * @brief    Flags defines which can be used with DMA2D_ReadReg function
  * @{
  */
#define DMA2D_FLAG_CEIF          DMA2D_ISR_CEIF     /*!< Configuration Error Interrupt Flag */
#define DMA2D_FLAG_CTCIF         DMA2D_ISR_CTCIF    /*!< CLUT Transfer Complete Interrupt Flag */
#define DMA2D_FLAG_CAEIF         DMA2D_ISR_CAEIF    /*!< CLUT Access Error Interrupt Flag */
#define DMA2D_FLAG_TWIF          DMA2D_ISR_TWIF     /*!< Transfer Watermark Interrupt Flag */
#define DMA2D_FLAG_TCIF          DMA2D_ISR_TCIF     /*!< Transfer Complete Interrupt Flag */
#define DMA2D_FLAG_TEIF          DMA2D_ISR_TEIF     /*!< Transfer Error Interrupt Flag */
/**
  * @}
  */

/** @defgroup DMA2D_EC_IT IT Defines
  * @brief    IT defines which can be used with DMA2D_ReadReg and  DMA2D_WriteReg functions
  * @{
  */
#define DMA2D_IT_CEIE             DMA2D_CR_CEIE    /*!< Configuration Error Interrupt */
#define DMA2D_IT_CTCIE            DMA2D_CR_CTCIE   /*!< CLUT Transfer Complete Interrupt */
#define DMA2D_IT_CAEIE            DMA2D_CR_CAEIE   /*!< CLUT Access Error Interrupt */
#define DMA2D_IT_TWIE             DMA2D_CR_TWIE    /*!< Transfer Watermark Interrupt */
#define DMA2D_IT_TCIE             DMA2D_CR_TCIE    /*!< Transfer Complete Interrupt */
#define DMA2D_IT_TEIE             DMA2D_CR_TEIE    /*!< Transfer Error Interrupt */
/**
  * @}
  */

/** @defgroup DMA2D_EC_MODE Mode
  * @{
  */
#define DMA2D_MODE_M2M                       0x00000000U                       /*!< DMA2D memory to memory transfer mode */
#define DMA2D_MODE_M2M_PFC                   DMA2D_CR_MODE_0                   /*!< DMA2D memory to memory with pixel format conversion transfer mode */
#define DMA2D_MODE_M2M_BLEND                 DMA2D_CR_MODE_1                   /*!< DMA2D memory to memory with blending transfer mode */
#define DMA2D_MODE_R2M                       (DMA2D_CR_MODE_0|DMA2D_CR_MODE_1) /*!< DMA2D register to memory transfer mode */
#define DMA2D_MODE_M2M_BLEND_FIXED_COLOR_FG  DMA2D_CR_MODE_2                   /*!< DMA2D memory to memory with blending transfer mode and fixed color foreground */
#define DMA2D_MODE_M2M_BLEND_FIXED_COLOR_BG  (DMA2D_CR_MODE_0|DMA2D_CR_MODE_2) /*!< DMA2D memory to memory with blending transfer mode and fixed color background */
/**
  * @}
  */

/** @defgroup DMA2D_EC_OUTPUT_COLOR_MODE Output Color Mode
  * @{
  */
#define DMA2D_OUTPUT_MODE_ARGB8888     0x00000000U                           /*!< ARGB8888 */
#define DMA2D_OUTPUT_MODE_RGB888       DMA2D_OPFCCR_CM_0                     /*!< RGB888   */
#define DMA2D_OUTPUT_MODE_RGB565       DMA2D_OPFCCR_CM_1                     /*!< RGB565   */
#define DMA2D_OUTPUT_MODE_ARGB1555     (DMA2D_OPFCCR_CM_0|DMA2D_OPFCCR_CM_1) /*!< ARGB1555 */
#define DMA2D_OUTPUT_MODE_ARGB4444     DMA2D_OPFCCR_CM_2                     /*!< ARGB4444 */
/**
  * @}
  */

/** @defgroup DMA2D_EC_INPUT_COLOR_MODE Input Color Mode
  * @{
  */
#define DMA2D_INPUT_MODE_ARGB8888      0x00000000U                                                /*!< ARGB8888 */
#define DMA2D_INPUT_MODE_RGB888        DMA2D_FGPFCCR_CM_0                                         /*!< RGB888   */
#define DMA2D_INPUT_MODE_RGB565        DMA2D_FGPFCCR_CM_1                                         /*!< RGB565   */
#define DMA2D_INPUT_MODE_ARGB1555      (DMA2D_FGPFCCR_CM_0|DMA2D_FGPFCCR_CM_1)                    /*!< ARGB1555 */
#define DMA2D_INPUT_MODE_ARGB4444      DMA2D_FGPFCCR_CM_2                                         /*!< ARGB4444 */
#define DMA2D_INPUT_MODE_L8            (DMA2D_FGPFCCR_CM_0|DMA2D_FGPFCCR_CM_2)                    /*!< L8       */
#define DMA2D_INPUT_MODE_AL44          (DMA2D_FGPFCCR_CM_1|DMA2D_FGPFCCR_CM_2)                    /*!< AL44     */
#define DMA2D_INPUT_MODE_AL88          (DMA2D_FGPFCCR_CM_0|DMA2D_FGPFCCR_CM_1|DMA2D_FGPFCCR_CM_2) /*!< AL88     */
#define DMA2D_INPUT_MODE_L4            DMA2D_FGPFCCR_CM_3                                         /*!< L4       */
#define DMA2D_INPUT_MODE_A8            (DMA2D_FGPFCCR_CM_0|DMA2D_FGPFCCR_CM_3)                    /*!< A8       */
#define DMA2D_INPUT_MODE_A4            (DMA2D_FGPFCCR_CM_1|DMA2D_FGPFCCR_CM_3)                    /*!< A4       */
#define DMA2D_INPUT_MODE_YCBCR         (DMA2D_FGPFCCR_CM_0|DMA2D_FGPFCCR_CM_1|DMA2D_FGPFCCR_CM_3) /*!< YCbCr    */
/**
  * @}
  */

/** @defgroup DMA2D_EC_ALPHA_MODE Alpha Mode
  * @{
  */
#define DMA2D_ALPHA_MODE_NO_MODIF       0x00000000U             /*!< No modification of the alpha channel value */
#define DMA2D_ALPHA_MODE_REPLACE        DMA2D_FGPFCCR_AM_0      /*!< Replace original alpha channel value by
                                                                        programmed alpha value                     */
#define DMA2D_ALPHA_MODE_COMBINE        DMA2D_FGPFCCR_AM_1      /*!< Replace original alpha channel value by
...
/** @defgroup DMA2D_EC_OUTPUT_SWAP_MODE Swap Mode
  * @{
  */
#define DMA2D_SWAP_MODE_REGULAR        0x00000000U                      /*!< Regular order */
#define DMA2D_SWAP_MODE_TWO_BY_TWO     DMA2D_OPFCCR_SB                  /*!< Bytes swapped two by two */
/**
  * @}
  */

/** @defgroup DMA2D_EC_RED_BLUE_SWAP Red Blue Swap
  * @{
  */
#define DMA2D_RB_MODE_REGULAR          0x00000000U                      /*!< RGB or ARGB */
#define DMA2D_RB_MODE_SWAP             DMA2D_FGPFCCR_RBS                /*!< BGR or ABGR */
/**
  * @}
  */

/** @defgroup DMA2D_EC_ALPHA_INVERSION Alpha Inversion
  * @{
  */
#define DMA2D_ALPHA_REGULAR          0x00000000U                     /*!< Regular alpha  */
#define DMA2D_ALPHA_INVERTED         DMA2D_FGPFCCR_AI                /*!< Inverted alpha */
/**
  * @}
  */

/** @defgroup DMA2D_EC_ROTATION rotation
  * @{
  */
#define DMA2D_ROTATION_0          		0x00000000U 
#define DMA2D_ROTATION_90          		DMA2D_OPFCCR_ROT_0   
#define DMA2D_ROTATION_180          	DMA2D_OPFCCR_ROT_1   
#define DMA2D_ROTATION_270          	(DMA2D_OPFCCR_ROT_0 | DMA2D_OPFCCR_ROT_1)   
              
/**
  * @}
  */

/** @defgroup DMA2D_EC_LINE_OFFSET_MODE Line Offset Mode
  * @{
  */
#define DMA2D_LINE_OFFSET_PIXELS     0x00000000U                     /*!< Line offsets are expressed in pixels  */
#define DMA2D_LINE_OFFSET_BYTES      DMA2D_CR_LOM                    /*!< Line offsets are expressed in bytes   */
/**
  * @}
  */

/** @defgroup DMA2D_EC_CLUT_COLOR_MODE CLUT Color Mode
  * @{
  */
#define DMA2D_CLUT_COLOR_MODE_ARGB8888          0x00000000U                     /*!< ARGB8888 */
#define DMA2D_CLUT_COLOR_MODE_RGB888            DMA2D_FGPFCCR_CCM               /*!< RGB888   */
/**
  * @}
  */

/** @defgroup DMA2D_CHROMA_SUB_SAMPLING Chroma Sub Sampling
  * @{
  */
#define DMA2D_CSS_444              0x00000000U             /*!< No chroma sub-sampling 4:4:4 */
#define DMA2D_CSS_422              DMA2D_FGPFCCR_CSS_0     /*!< chroma sub-sampling 4:2:2 */
#define DMA2D_CSS_420              DMA2D_FGPFCCR_CSS_1     /*!< chroma sub-sampling 4:2:0 */
/**
  * @}
  */
...
#define IS_DMA2D_FGCM(FGCM)                                                                                                                                  \
    (((FGCM) == CM_ARGB8888) || ((FGCM) == CM_RGB888) || ((FGCM) == CM_RGB565) || ((FGCM) == CM_ARGB1555) || ((FGCM) == CM_ARGB4444) || ((FGCM) == CM_L8) || \
     ((FGCM) == CM_AL44) || ((FGCM) == CM_AL88) || ((FGCM) == CM_L4) || ((FGCM) == CM_A8) || ((FGCM) == CM_A4))

#define IS_DMA2D_BGCM(BGCM)                                                                                                                                  \
    (((BGCM) == CM_ARGB8888) || ((BGCM) == CM_RGB888) || ((BGCM) == CM_RGB565) || ((BGCM) == CM_ARGB1555) || ((BGCM) == CM_ARGB4444) || ((BGCM) == CM_L8) || \
     ((BGCM) == CM_AL44) || ((BGCM) == CM_AL88) || ((BGCM) == CM_L4) || ((BGCM) == CM_A8) || ((BGCM) == CM_A4))
...
/** @defgroup DMA2D_EM_WRITE_READ Common Write and read registers Macros
  * @{
  */
...
/**
  ...
  * @retval None
  */
#define DMA2D_WriteReg(__INSTANCE__, __REG__, __VALUE__) WRITE_REG((__INSTANCE__)->__REG__, (__VALUE__))
...
/**
  ...
  */
#define DMA2D_ReadReg(__INSTANCE__, __REG__) READ_REG((__INSTANCE__)->__REG__)
/**
  * @}
  */
...
/** @defgroup DMA2D_EF_Configuration Configuration Functions
  * @{
  */

/**
  * @brief  Start a DMA2D transfer.
  * @rmtoll CR          START            DMA2D_Start
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_Start(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          START            DMA2D_IsTransferOngoing
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsTransferOngoing(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          SUSP            DMA2D_Suspend
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_Suspend(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          SUSP            DMA2D_Resume
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_Resume(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          SUSP            DMA2D_IsSuspended
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsSuspended(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          ABORT            DMA2D_Abort
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_Abort(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          ABORT            DMA2D_IsAborted
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsAborted(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          MODE          DMA2D_SetMode
  * @param  DMA2Dx DMA2D Instance
  * @param  Mode This parameter can be one of the following values:
  *         @arg @ref DMA2D_MODE_M2M
  *         @arg @ref DMA2D_MODE_M2M_PFC
  *         @arg @ref DMA2D_MODE_M2M_BLEND
  *         @arg @ref DMA2D_MODE_R2M
  *         @arg @ref DMA2D_MODE_M2M_BLEND_FIXED_COLOR_FG
  *         @arg @ref DMA2D_MODE_M2M_BLEND_FIXED_COLOR_BG
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetMode(DMA2D_TypeDef *DMA2Dx, uint32_t Mode)
{
...
/**
  ...
  *         @arg @ref DMA2D_MODE_M2M_BLEND_FIXED_COLOR_BG
  */
__STATIC_INLINE uint32_t DMA2D_GetMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll OPFCCR          CM          DMA2D_SetOutputColorMode
  * @param  DMA2Dx DMA2D Instance
  * @param  ColorMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_OUTPUT_MODE_ARGB8888
  *         @arg @ref DMA2D_OUTPUT_MODE_RGB888
  *         @arg @ref DMA2D_OUTPUT_MODE_RGB565
  *         @arg @ref DMA2D_OUTPUT_MODE_ARGB1555
  *         @arg @ref DMA2D_OUTPUT_MODE_ARGB4444
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputColorMode(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode)
{
...
/**
  ...
  * @rmtoll OPFCCR          CM         DMA2D_GetOutputColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_OUTPUT_MODE_ARGB8888
  *         @arg @ref DMA2D_OUTPUT_MODE_RGB888
  ...
  *         @arg @ref DMA2D_OUTPUT_MODE_ARGB4444
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputColorMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll OPFCCR          RBS          DMA2D_SetOutputRBSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @param  RBSwapMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_RB_MODE_REGULAR
  *         @arg @ref DMA2D_RB_MODE_SWAP
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputRBSwapMode(DMA2D_TypeDef *DMA2Dx, uint32_t RBSwapMode)
{
...
/**
  ...
  * @rmtoll OPFCCR          RBS         DMA2D_GetOutputRBSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_RB_MODE_REGULAR
  *         @arg @ref DMA2D_RB_MODE_SWAP
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputRBSwapMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll OPFCCR          AI          DMA2D_SetOutputAlphaInvMode
  * @param  DMA2Dx DMA2D Instance
  * @param  AlphaInversionMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_REGULAR
  *         @arg @ref DMA2D_ALPHA_INVERTED
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputAlphaInvMode(DMA2D_TypeDef *DMA2Dx, uint32_t AlphaInversionMode)
{
...
/**
  ...
  * @rmtoll OPFCCR          AI         DMA2D_GetOutputAlphaInvMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_REGULAR
  *         @arg @ref DMA2D_ALPHA_INVERTED
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputAlphaInvMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll OPFCCR          SB          DMA2D_SetOutputSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @param  OutputSwapMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_SWAP_MODE_REGULAR
  *         @arg @ref DMA2D_SWAP_MODE_TWO_BY_TWO
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputSwapMode(DMA2D_TypeDef *DMA2Dx, uint32_t OutputSwapMode)
{
...
/**
  ...
  * @rmtoll OPFCCR          SB         DMA2D_GetOutputSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_SWAP_MODE_REGULAR
  *         @arg @ref DMA2D_SWAP_MODE_TWO_BY_TWO
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputSwapMode(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(READ_BIT(DMA2Dx->OPFCCR, DMA2D_OPFCCR_SB));
}

/**
  * @brief  Set DMA2D output rotation mode.
  * @rmtoll OPFCCR          ROT          DMA2D_OutputRotationMode
  * @param  DMA2Dx DMA2D Instance
  * @param  OutputRotationMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_ROTATION_0
  *         @arg @ref DMA2D_ROTATION_90
  *         @arg @ref DMA2D_ROTATION_180
  *         @arg @ref DMA2D_ROTATION_270
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputRotationMode(DMA2D_TypeDef *DMA2Dx, uint32_t OutputRotationMode)
{
  MODIFY_REG(DMA2Dx->OPFCCR, DMA2D_OPFCCR_ROT, OutputRotationMode);
}

/**
  * @brief  Return DMA2D output rotation mode.
  * @rmtoll OPFCCR          ROT         DMA2D_OutputRotationMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_ROTATION_0
  ...
  *         @arg @ref DMA2D_ROTATION_270
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputRotationMode(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(READ_BIT(DMA2Dx->OPFCCR, DMA2D_OPFCCR_ROT));
}
/**
  * @brief  Set DMA2D line offset mode.
  * @rmtoll CR          LOM          DMA2D_SetLineOffsetMode
  * @param  DMA2Dx DMA2D Instance
  * @param  LineOffsetMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_LINE_OFFSET_PIXELS
  *         @arg @ref DMA2D_LINE_OFFSET_BYTES
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetLineOffsetMode(DMA2D_TypeDef *DMA2Dx, uint32_t LineOffsetMode)
{
...
/**
  ...
  * @rmtoll CR          LOM         DMA2D_GetLineOffsetMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_LINE_OFFSET_PIXELS
  *         @arg @ref DMA2D_LINE_OFFSET_BYTES
  */
__STATIC_INLINE uint32_t DMA2D_GetLineOffsetMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll OOR          LO          DMA2D_SetLineOffset
  * @param  DMA2Dx DMA2D Instance
  * @param  LineOffset Value between Min_Data=0 and Max_Data=0xFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetLineOffset(DMA2D_TypeDef *DMA2Dx, uint32_t LineOffset)
{
...
/**
  ...
  * @rmtoll OOR          LO         DMA2D_GetLineOffset
  * @param  DMA2Dx DMA2D Instance
  * @retval Line offset value between Min_Data=0 and Max_Data=0xFFFF
  */
__STATIC_INLINE uint32_t DMA2D_GetLineOffset(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll NLR          PL          DMA2D_SetNbrOfPixelsPerLines
  * @param  DMA2Dx DMA2D Instance
  * @param  NbrOfPixelsPerLines Value between Min_Data=0 and Max_Data=0x3FFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetNbrOfPixelsPerLines(DMA2D_TypeDef *DMA2Dx, uint32_t NbrOfPixelsPerLines)
{
...
/**
  ...
  * @rmtoll NLR          PL          DMA2D_GetNbrOfPixelsPerLines
  * @param  DMA2Dx DMA2D Instance
  * @retval Number of pixels per lines value between Min_Data=0 and Max_Data=0x3FFF
  */
__STATIC_INLINE uint32_t DMA2D_GetNbrOfPixelsPerLines(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll NLR          NL          DMA2D_SetNbrOfLines
  * @param  DMA2Dx DMA2D Instance
  * @param  NbrOfLines Value between Min_Data=0 and Max_Data=0xFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetNbrOfLines(DMA2D_TypeDef *DMA2Dx, uint32_t NbrOfLines)
{
...
/**
  ...
  * @rmtoll NLR          NL          DMA2D_GetNbrOfLines
  * @param  DMA2Dx DMA2D Instance
  * @retval Number of lines value between Min_Data=0 and Max_Data=0xFFFF
  */
__STATIC_INLINE uint32_t DMA2D_GetNbrOfLines(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll OMAR          MA          DMA2D_SetOutputMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @param  OutputMemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputMemAddr(DMA2D_TypeDef *DMA2Dx, uint32_t OutputMemoryAddress)
{
  DMA2D_WriteReg(DMA2Dx, OMAR, OutputMemoryAddress);
}

/**
  * @brief  Get DMA2D output memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll OMAR          MA          DMA2D_GetOutputMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @retval Output memory address value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputMemAddr(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(DMA2D_ReadReg(DMA2Dx, OMAR));
}
...
/**
  ...
  * @note DMA2D_ConfigOutputColor() API may be used instead if colors values formatting
  *       with respect to color mode is not done by the user code.
  * @rmtoll OCOLR        BLUE        DMA2D_SetOutputColor\n
  *         OCOLR        GREEN       DMA2D_SetOutputColor\n
  *         OCOLR        RED         DMA2D_SetOutputColor\n
  *         OCOLR        ALPHA       DMA2D_SetOutputColor
  * @param  DMA2Dx DMA2D Instance
  * @param  OutputColor Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetOutputColor(DMA2D_TypeDef *DMA2Dx, uint32_t OutputColor)
{
...
/**
  ...
  *         as set by @ref DMA2D_SetOutputColorMode.
  * @rmtoll OCOLR        BLUE        DMA2D_GetOutputColor\n
  *         OCOLR        GREEN       DMA2D_GetOutputColor\n
  *         OCOLR        RED         DMA2D_GetOutputColor\n
  *         OCOLR        ALPHA       DMA2D_GetOutputColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Output color value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t DMA2D_GetOutputColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll LWR          LW          DMA2D_SetLineWatermark
  * @param  DMA2Dx DMA2D Instance
  * @param  LineWatermark Value between Min_Data=0 and Max_Data=0xFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetLineWatermark(DMA2D_TypeDef *DMA2Dx, uint32_t LineWatermark)
{
...
/**
  ...
  * @rmtoll LWR          LW          DMA2D_GetLineWatermark
  * @param  DMA2Dx DMA2D Instance
  * @retval Line watermark value between Min_Data=0 and Max_Data=0xFFFF
  */
__STATIC_INLINE uint32_t DMA2D_GetLineWatermark(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll AMTCR          DT          DMA2D_SetDeadTime
  * @param  DMA2Dx DMA2D Instance
  * @param  DeadTime Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_SetDeadTime(DMA2D_TypeDef *DMA2Dx, uint32_t DeadTime)
{
...
/**
  ...
  * @rmtoll AMTCR          DT          DMA2D_GetDeadTime
  * @param  DMA2Dx DMA2D Instance
  * @retval Dead time value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t DMA2D_GetDeadTime(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll AMTCR          EN            DMA2D_EnableDeadTime
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableDeadTime(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll AMTCR          EN            DMA2D_DisableDeadTime
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableDeadTime(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll AMTCR          EN            DMA2D_IsEnabledDeadTime
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledDeadTime(DMA2D_TypeDef *DMA2Dx)
{
  return ((READ_BIT(DMA2Dx->AMTCR, DMA2D_AMTCR_EN) == (DMA2D_AMTCR_EN)) ? 1UL : 0UL);
}

/** @defgroup DMA2D_EF_FGND_Configuration Foreground Configuration Functions
  * @{
  */

/**
  * @brief  Set DMA2D foreground memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll FGMAR          MA          DMA2D_FGND_SetMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @param  MemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetMemAddr(DMA2D_TypeDef *DMA2Dx, uint32_t MemoryAddress)
{
  DMA2D_WriteReg(DMA2Dx, FGMAR, MemoryAddress);
}

/**
  * @brief  Get DMA2D foreground memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll FGMAR          MA          DMA2D_FGND_GetMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground memory address value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetMemAddr(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(DMA2D_ReadReg(DMA2Dx, FGMAR));
}

/**
  * @brief  Enable DMA2D foreground CLUT loading.
  * @rmtoll FGPFCCR          START            DMA2D_FGND_EnableCLUTLoad
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_EnableCLUTLoad(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          START            DMA2D_FGND_IsEnabledCLUTLoad
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_FGND_IsEnabledCLUTLoad(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CM          DMA2D_FGND_SetColorMode
  * @param  DMA2Dx DMA2D Instance
  * @param  ColorMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_INPUT_MODE_ARGB8888
  *         @arg @ref DMA2D_INPUT_MODE_RGB888
  *         @arg @ref DMA2D_INPUT_MODE_RGB565
  *         @arg @ref DMA2D_INPUT_MODE_ARGB1555
  *         @arg @ref DMA2D_INPUT_MODE_ARGB4444
  *         @arg @ref DMA2D_INPUT_MODE_L8
  *         @arg @ref DMA2D_INPUT_MODE_AL44
  *         @arg @ref DMA2D_INPUT_MODE_AL88
  *         @arg @ref DMA2D_INPUT_MODE_L4
  *         @arg @ref DMA2D_INPUT_MODE_A8
  *         @arg @ref DMA2D_INPUT_MODE_A4
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetColorMode(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CM         DMA2D_FGND_GetColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_INPUT_MODE_ARGB8888
  *         @arg @ref DMA2D_INPUT_MODE_RGB888
  ...
  *         @arg @ref DMA2D_INPUT_MODE_A4
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetColorMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          AM          DMA2D_FGND_SetAlphaMode
  * @param  DMA2Dx DMA2D Instance
  * @param  AphaMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_MODE_NO_MODIF
  *         @arg @ref DMA2D_ALPHA_MODE_REPLACE
  *         @arg @ref DMA2D_ALPHA_MODE_COMBINE
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetAlphaMode(DMA2D_TypeDef *DMA2Dx, uint32_t AphaMode)
{
...
/**
  ...
  * @rmtoll FGPFCCR          AM         DMA2D_FGND_GetAlphaMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_MODE_NO_MODIF
  *         @arg @ref DMA2D_ALPHA_MODE_REPLACE
  *         @arg @ref DMA2D_ALPHA_MODE_COMBINE
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetAlphaMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          ALPHA          DMA2D_FGND_SetAlpha
  * @param  DMA2Dx DMA2D Instance
  * @param  Alpha Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetAlpha(DMA2D_TypeDef *DMA2Dx, uint32_t Alpha)
{
...
/**
  ...
  * @rmtoll FGPFCCR          ALPHA         DMA2D_FGND_GetAlpha
  * @param  DMA2Dx DMA2D Instance
  * @retval Alpha value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetAlpha(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          RBS          DMA2D_FGND_SetRBSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @param  RBSwapMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_RB_MODE_REGULAR
  *         @arg @ref DMA2D_RB_MODE_SWAP
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetRBSwapMode(DMA2D_TypeDef *DMA2Dx, uint32_t RBSwapMode)
{
...
/**
  ...
  * @rmtoll FGPFCCR          RBS         DMA2D_FGND_GetRBSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_RB_MODE_REGULAR
  *         @arg @ref DMA2D_RB_MODE_SWAP
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetRBSwapMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          AI          DMA2D_FGND_SetAlphaInvMode
  * @param  DMA2Dx DMA2D Instance
  * @param  AlphaInversionMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_REGULAR
  *         @arg @ref DMA2D_ALPHA_INVERTED
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetAlphaInvMode(DMA2D_TypeDef *DMA2Dx, uint32_t AlphaInversionMode)
{
...
/**
  ...
  * @rmtoll FGPFCCR          AI         DMA2D_FGND_GetAlphaInvMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_REGULAR
  *         @arg @ref DMA2D_ALPHA_INVERTED
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetAlphaInvMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGOR          LO          DMA2D_FGND_SetLineOffset
  * @param  DMA2Dx DMA2D Instance
  * @param  LineOffset Value between Min_Data=0 and Max_Data=0x3FF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetLineOffset(DMA2D_TypeDef *DMA2Dx, uint32_t LineOffset)
{
...
/**
  ...
  * @rmtoll FGOR          LO         DMA2D_FGND_GetLineOffset
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground line offset value between Min_Data=0 and Max_Data=0x3FF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetLineOffset(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGCOLR          RED          DMA2D_FGND_SetColor
  * @rmtoll FGCOLR          GREEN        DMA2D_FGND_SetColor
  * @rmtoll FGCOLR          BLUE         DMA2D_FGND_SetColor
  * @param  DMA2Dx DMA2D Instance
  ...
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetColor(DMA2D_TypeDef *DMA2Dx, uint32_t Red, uint32_t Green, uint32_t Blue)
{
...
/**
  ...
  * @rmtoll FGCOLR          RED          DMA2D_FGND_SetRedColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Red Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetRedColor(DMA2D_TypeDef *DMA2Dx, uint32_t Red)
{
...
/**
  ...
  * @rmtoll FGCOLR          RED         DMA2D_FGND_GetRedColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Red color value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetRedColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGCOLR          GREEN          DMA2D_FGND_SetGreenColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Green Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetGreenColor(DMA2D_TypeDef *DMA2Dx, uint32_t Green)
{
...
/**
  ...
  * @rmtoll FGCOLR          GREEN         DMA2D_FGND_GetGreenColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Green color value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetGreenColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGCOLR          BLUE          DMA2D_FGND_SetBlueColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Blue Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetBlueColor(DMA2D_TypeDef *DMA2Dx, uint32_t Blue)
{
...
/**
  ...
  * @rmtoll FGCOLR          BLUE         DMA2D_FGND_GetBlueColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Blue color value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetBlueColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGCMAR          MA          DMA2D_FGND_SetCLUTMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTMemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetCLUTMemAddr(DMA2D_TypeDef *DMA2Dx, uint32_t CLUTMemoryAddress)
{
  DMA2D_WriteReg(DMA2Dx, FGCMAR, CLUTMemoryAddress);
}

/**
  * @brief  Get DMA2D foreground CLUT memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll FGCMAR          MA          DMA2D_FGND_GetCLUTMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground CLUT memory address value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetCLUTMemAddr(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(DMA2D_ReadReg(DMA2Dx, FGCMAR));
}

/**
  * @brief  Set DMA2D foreground CLUT size, expressed on 8 bits ([7:0] bits).
  * @rmtoll FGPFCCR          CS          DMA2D_FGND_SetCLUTSize
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTSize Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetCLUTSize(DMA2D_TypeDef *DMA2Dx, uint32_t CLUTSize)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CS          DMA2D_FGND_GetCLUTSize
  * @param  DMA2Dx DMA2D Instance
  * @retval Foreground CLUT size value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetCLUTSize(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CCM          DMA2D_FGND_SetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTColorMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_RGB888
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetCLUTColorMode(DMA2D_TypeDef *DMA2Dx, uint32_t CLUTColorMode)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CCM         DMA2D_FGND_GetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_RGB888
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetCLUTColorMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CSS          DMA2D_FGND_SetChrSubSampling
  * @param  DMA2Dx DMA2D Instance
  * @param  ChromaSubSampling This parameter can be one of the following values:
  *         @arg @ref DMA2D_CSS_444
  *         @arg @ref DMA2D_CSS_422
  *         @arg @ref DMA2D_CSS_420
  * @retval None
  */
__STATIC_INLINE void DMA2D_FGND_SetChrSubSampling(DMA2D_TypeDef *DMA2Dx, uint32_t ChromaSubSampling)
{
...
/**
  ...
  * @rmtoll FGPFCCR          CSS         DMA2D_FGND_GetChrSubSampling
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_CSS_444
  *         @arg @ref DMA2D_CSS_422
  *         @arg @ref DMA2D_CSS_420
  */
__STATIC_INLINE uint32_t DMA2D_FGND_GetChrSubSampling(DMA2D_TypeDef *DMA2Dx)
{
...
/** @defgroup DMA2D_EF_BGND_Configuration Background Configuration Functions
  * @{
  */

/**
  * @brief  Set DMA2D background memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll BGMAR          MA          DMA2D_BGND_SetMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @param  MemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetMemAddr(DMA2D_TypeDef *DMA2Dx, uint32_t MemoryAddress)
{
  DMA2D_WriteReg(DMA2Dx, BGMAR, MemoryAddress);
}

/**
  * @brief  Get DMA2D background memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll BGMAR          MA          DMA2D_BGND_GetMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @retval Background memory address value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t DMA2D_BGND_GetMemAddr(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(DMA2D_ReadReg(DMA2Dx, BGMAR));
}

/**
  * @brief  Enable DMA2D background CLUT loading.
  * @rmtoll BGPFCCR          START            DMA2D_BGND_EnableCLUTLoad
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_EnableCLUTLoad(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          START            DMA2D_BGND_IsEnabledCLUTLoad
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_BGND_IsEnabledCLUTLoad(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          CM          DMA2D_BGND_SetColorMode
  * @param  DMA2Dx DMA2D Instance
  * @param  ColorMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_INPUT_MODE_ARGB8888
  *         @arg @ref DMA2D_INPUT_MODE_RGB888
  ...
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetColorMode(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode)
{
...
/**
  ...
  * @rmtoll BGPFCCR          CM          DMA2D_BGND_GetColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_INPUT_MODE_ARGB8888
  *         @arg @ref DMA2D_INPUT_MODE_RGB888
  ...
  *         @arg @ref DMA2D_INPUT_MODE_A4
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetColorMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          AM         DMA2D_BGND_SetAlphaMode
  * @param  DMA2Dx DMA2D Instance
  * @param  AphaMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_MODE_NO_MODIF
  *         @arg @ref DMA2D_ALPHA_MODE_REPLACE
  ...
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetAlphaMode(DMA2D_TypeDef *DMA2Dx, uint32_t AphaMode)
{
...
/**
  ...
  * @rmtoll BGPFCCR          AM          DMA2D_BGND_GetAlphaMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_MODE_NO_MODIF
  *         @arg @ref DMA2D_ALPHA_MODE_REPLACE
  *         @arg @ref DMA2D_ALPHA_MODE_COMBINE
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetAlphaMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          ALPHA         DMA2D_BGND_SetAlpha
  * @param  DMA2Dx DMA2D Instance
  * @param  Alpha Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetAlpha(DMA2D_TypeDef *DMA2Dx, uint32_t Alpha)
{
...
/**
  ...
  * @rmtoll BGPFCCR          ALPHA          DMA2D_BGND_GetAlpha
  * @param  DMA2Dx DMA2D Instance
  * @retval Alpha value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetAlpha(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          RBS         DMA2D_BGND_SetRBSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @param  RBSwapMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_RB_MODE_REGULAR
  *         @arg @ref DMA2D_RB_MODE_SWAP
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetRBSwapMode(DMA2D_TypeDef *DMA2Dx, uint32_t RBSwapMode)
{
...
/**
  ...
  * @rmtoll BGPFCCR          RBS          DMA2D_BGND_GetRBSwapMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_RB_MODE_REGULAR
  *         @arg @ref DMA2D_RB_MODE_SWAP
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetRBSwapMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          AI         DMA2D_BGND_SetAlphaInvMode
  * @param  DMA2Dx DMA2D Instance
  * @param  AlphaInversionMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_REGULAR
  *         @arg @ref DMA2D_ALPHA_INVERTED
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetAlphaInvMode(DMA2D_TypeDef *DMA2Dx, uint32_t AlphaInversionMode)
{
...
/**
  ...
  * @rmtoll BGPFCCR          AI          DMA2D_BGND_GetAlphaInvMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_ALPHA_REGULAR
  *         @arg @ref DMA2D_ALPHA_INVERTED
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetAlphaInvMode(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGOR          LO         DMA2D_BGND_SetLineOffset
  * @param  DMA2Dx DMA2D Instance
  * @param  LineOffset Value between Min_Data=0 and Max_Data=0x3FF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetLineOffset(DMA2D_TypeDef *DMA2Dx, uint32_t LineOffset)
{
...
/**
  ...
  * @rmtoll BGOR          LO          DMA2D_BGND_GetLineOffset
  * @param  DMA2Dx DMA2D Instance
  * @retval Background line offset value between Min_Data=0 and Max_Data=0x3FF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetLineOffset(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGCOLR          RED          DMA2D_BGND_SetColor
  * @rmtoll BGCOLR          GREEN        DMA2D_BGND_SetColor
  * @rmtoll BGCOLR          BLUE         DMA2D_BGND_SetColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Red   Value between Min_Data=0 and Max_Data=0xFF
  * @param  Green Value between Min_Data=0 and Max_Data=0xFF
  * @param  Blue  Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetColor(DMA2D_TypeDef *DMA2Dx, uint32_t Red, uint32_t Green, uint32_t Blue)
{
...
/**
  ...
  * @rmtoll BGCOLR          RED         DMA2D_BGND_SetRedColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Red Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetRedColor(DMA2D_TypeDef *DMA2Dx, uint32_t Red)
{
...
/**
  ...
  * @rmtoll BGCOLR          RED          DMA2D_BGND_GetRedColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Red color value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetRedColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGCOLR          GREEN         DMA2D_BGND_SetGreenColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Green Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetGreenColor(DMA2D_TypeDef *DMA2Dx, uint32_t Green)
{
...
/**
  ...
  * @rmtoll BGCOLR          GREEN          DMA2D_BGND_GetGreenColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Green color value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetGreenColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGCOLR          BLUE         DMA2D_BGND_SetBlueColor
  * @param  DMA2Dx DMA2D Instance
  * @param  Blue Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetBlueColor(DMA2D_TypeDef *DMA2Dx, uint32_t Blue)
{
...
/**
  ...
  * @rmtoll BGCOLR          BLUE          DMA2D_BGND_GetBlueColor
  * @param  DMA2Dx DMA2D Instance
  * @retval Blue color value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetBlueColor(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGCMAR          MA         DMA2D_BGND_SetCLUTMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTMemoryAddress Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetCLUTMemAddr(DMA2D_TypeDef *DMA2Dx, uint32_t CLUTMemoryAddress)
{
  DMA2D_WriteReg(DMA2Dx, BGCMAR, CLUTMemoryAddress);
}

/**
  * @brief  Get DMA2D background CLUT memory address, expressed on 32 bits ([31:0] bits).
  * @rmtoll BGCMAR          MA           DMA2D_BGND_GetCLUTMemAddr
  * @param  DMA2Dx DMA2D Instance
  * @retval Background CLUT memory address value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetCLUTMemAddr(DMA2D_TypeDef *DMA2Dx)
{
  return (uint32_t)(DMA2D_ReadReg(DMA2Dx, BGCMAR));
}

/**
  * @brief  Set DMA2D background CLUT size, expressed on 8 bits ([7:0] bits).
  * @rmtoll BGPFCCR          CS         DMA2D_BGND_SetCLUTSize
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTSize Value between Min_Data=0 and Max_Data=0xFF
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetCLUTSize(DMA2D_TypeDef *DMA2Dx, uint32_t CLUTSize)
{
...
/**
  ...
  * @rmtoll BGPFCCR          CS           DMA2D_BGND_GetCLUTSize
  * @param  DMA2Dx DMA2D Instance
  * @retval Background CLUT size value between Min_Data=0 and Max_Data=0xFF
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetCLUTSize(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll BGPFCCR          CCM         DMA2D_BGND_SetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @param  CLUTColorMode This parameter can be one of the following values:
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_RGB888
  * @retval None
  */
__STATIC_INLINE void DMA2D_BGND_SetCLUTColorMode(DMA2D_TypeDef *DMA2Dx, uint32_t CLUTColorMode)
{
...
/**
  ...
  * @rmtoll BGPFCCR          CCM          DMA2D_BGND_GetCLUTColorMode
  * @param  DMA2Dx DMA2D Instance
  * @retval Returned value can be one of the following values:
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_ARGB8888
  *         @arg @ref DMA2D_CLUT_COLOR_MODE_RGB888
  */
__STATIC_INLINE uint32_t  DMA2D_BGND_GetCLUTColorMode(DMA2D_TypeDef *DMA2Dx)
{
...
/** @defgroup DMA2D_EF_FLAG_MANAGEMENT Flag Management
  * @{
  */

/**
  * @brief  Check if the DMA2D Configuration Error Interrupt Flag is set or not
  * @rmtoll ISR          CEIF            DMA2D_IsActiveFlag_CE
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsActiveFlag_CE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll ISR          CTCIF            DMA2D_IsActiveFlag_CTC
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsActiveFlag_CTC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll ISR          CAEIF            DMA2D_IsActiveFlag_CAE
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsActiveFlag_CAE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll ISR          TWIF            DMA2D_IsActiveFlag_TW
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsActiveFlag_TW(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll ISR          TCIF            DMA2D_IsActiveFlag_TC
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsActiveFlag_TC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll ISR          TEIF            DMA2D_IsActiveFlag_TE
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsActiveFlag_TE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll IFCR          CCEIF          DMA2D_ClearFlag_CE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_ClearFlag_CE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll IFCR          CCTCIF          DMA2D_ClearFlag_CTC
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_ClearFlag_CTC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll IFCR          CAECIF          DMA2D_ClearFlag_CAE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_ClearFlag_CAE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll IFCR          CTWIF          DMA2D_ClearFlag_TW
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_ClearFlag_TW(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll IFCR          CTCIF          DMA2D_ClearFlag_TC
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_ClearFlag_TC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll IFCR          CTEIF          DMA2D_ClearFlag_TE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_ClearFlag_TE(DMA2D_TypeDef *DMA2Dx)
{
...
/** @defgroup DMA2D_EF_IT_MANAGEMENT Interruption Management
  * @{
  */

/**
  * @brief  Enable Configuration Error Interrupt
  * @rmtoll CR          CEIE        DMA2D_EnableIT_CE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableIT_CE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CTCIE        DMA2D_EnableIT_CTC
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableIT_CTC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CAEIE        DMA2D_EnableIT_CAE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableIT_CAE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TWIE        DMA2D_EnableIT_TW
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableIT_TW(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TCIE        DMA2D_EnableIT_TC
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableIT_TC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TEIE        DMA2D_EnableIT_TE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_EnableIT_TE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CEIE        DMA2D_DisableIT_CE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableIT_CE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CTCIE        DMA2D_DisableIT_CTC
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableIT_CTC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CAEIE        DMA2D_DisableIT_CAE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableIT_CAE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TWIE        DMA2D_DisableIT_TW
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableIT_TW(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TCIE        DMA2D_DisableIT_TC
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableIT_TC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TEIE        DMA2D_DisableIT_TE
  * @param  DMA2Dx DMA2D Instance
  * @retval None
  */
__STATIC_INLINE void DMA2D_DisableIT_TE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CEIE        DMA2D_IsEnabledIT_CE
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledIT_CE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CTCIE        DMA2D_IsEnabledIT_CTC
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledIT_CTC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          CAEIE        DMA2D_IsEnabledIT_CAE
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledIT_CAE(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TWIE        DMA2D_IsEnabledIT_TW
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledIT_TW(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TCIE        DMA2D_IsEnabledIT_TC
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledIT_TC(DMA2D_TypeDef *DMA2Dx)
{
...
/**
  ...
  * @rmtoll CR          TEIE        DMA2D_IsEnabledIT_TE
  * @param  DMA2Dx DMA2D Instance
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t DMA2D_IsEnabledIT_TE(DMA2D_TypeDef *DMA2Dx)
{
...
/** @defgroup DMA2D_EF_Init_Functions Initialization and De-initialization Functions
  * @{
  */

ErrorStatus DMA2D_DeInit(DMA2D_TypeDef *DMA2Dx);
ErrorStatus DMA2D_Init(DMA2D_TypeDef *DMA2Dx, DMA2D_InitTypeDef *DMA2D_InitStruct);
void DMA2D_StructInit(DMA2D_InitTypeDef *DMA2D_InitStruct);
void DMA2D_ConfigLayer(DMA2D_TypeDef *DMA2Dx, DMA2D_LayerCfgTypeDef *DMA2D_LayerCfg, uint32_t LayerIdx);
void DMA2D_LayerCfgStructInit(DMA2D_LayerCfgTypeDef *DMA2D_LayerCfg);
void DMA2D_ConfigOutputColor(DMA2D_TypeDef *DMA2Dx, DMA2D_ColorTypeDef *DMA2D_ColorStruct);
uint32_t DMA2D_GetOutputBlueColor(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode);
uint32_t DMA2D_GetOutputGreenColor(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode);
uint32_t DMA2D_GetOutputRedColor(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode);
uint32_t DMA2D_GetOutputAlphaColor(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode);
void DMA2D_ConfigSize(DMA2D_TypeDef *DMA2Dx, uint32_t NbrOfLines, uint32_t NbrOfPixelsPerLines);
