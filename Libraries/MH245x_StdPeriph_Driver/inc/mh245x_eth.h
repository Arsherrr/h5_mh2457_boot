...
#ifndef __PERIPH_ETH_H__
#define __PERIPH_ETH_H__
...
#ifndef _eth_delay_
#define _eth_delay_ SystemDelay
#endif
...
#ifndef ETH_REG_WRITE_DELAY
#define ETH_REG_WRITE_DELAY (0x00000001U)
#endif

#ifndef USE_ENHANCED_DMA_DESCRIPTORS
...
#ifndef ETH_RXBUFNB
#define ETH_RXBUFNB 1 /* 4 Rx buffers of size ETH_RX_BUF_SIZE */
#endif

#ifndef ETH_TXBUFNB
#define ETH_TXBUFNB 1 /* 4 Tx buffers of size ETH_TX_BUF_SIZE */
#endif
...
/**
 * @brief  ETH PHY Description
 * @note
 */
typedef struct
{
    uint16_t Phy_Address;     /* PHY address */
    uint16_t Phy_SR_Offset;   /* PHY status register Offset */
    uint16_t Phy_Speed_Mask;  /* PHY Speed mask  1:100Mb/s     0:10Mb/s*/
    uint16_t Phy_Duplex_Mask; /* PHY Duplex mask 1:Full duplex  0:Half duplex*/
} PHY_DescripDef;
 ...
 * @{
 */
#define ETH_MAX_PACKET_SIZE 4096 /*!< ETH_HEADER + ETH_EXTRA + VLAN_TAG + MAX_ETH_PAYLOAD + ETH_CRC */
...
#define ETH_DMAPTPRxDesc_PTPMT_PdelayReq_Announce \
    ((uint32_t)0x00000500) /* PdelayReq message (peer-to-peer transparent clock) or Announce message (Ordinary or Boundary clock) */
#define ETH_DMAPTPRxDesc_PTPMT_PdelayResp_Manag \
    ((uint32_t)0x00000600) /* PdelayResp message (peer-to-peer transparent clock) or Management message (Ordinary or Boundary clock)  */
#define ETH_DMAPTPRxDesc_PTPMT_PdelayRespFollowUp_Signal \
    ((uint32_t)0x00000700) /* PdelayRespFollowUp message (peer-to-peer transparent clock) or Signaling message (Ordinary or Boundary clock) */
 ...
 * @{
 */
#define PHY_READ_TO  ((uint32_t)0x00010000)
#define PHY_WRITE_TO ((uint32_t)0x00010000)
...
#define IS_ETH_PHY_REG(REG) \
    (((REG) == PHY_BCR) || ((REG) == PHY_BSR) || ((REG) == PHY_SR) || ((REG) == PHY_2_BCR) || ((REG) == PHY_2_BSR) || ((REG) == PHY_2_SR) || \)
/**
 * @}
 */
 ...
 * @{
 */
#define PHY_Reset                   ((uint16_t)0x3100) /*!< PHY Reset */
...
#define IS_ETH_INTER_FRAME_GAP(GAP)                                                                                                                          \
    (((GAP) == ETH_InterFrameGap_96Bit) || ((GAP) == ETH_InterFrameGap_88Bit) || ((GAP) == ETH_InterFrameGap_80Bit) || ((GAP) == ETH_InterFrameGap_72Bit) || \
     ((GAP) == ETH_InterFrameGap_64Bit) || ((GAP) == ETH_InterFrameGap_56Bit) || ((GAP) == ETH_InterFrameGap_48Bit) || ((GAP) == ETH_InterFrameGap_40Bit))
...
#define IS_ETH_CARRIER_SENSE(CMD) (((CMD) == ETH_CarrierSense_Enable) || ((CMD) == ETH_CarrierSense_Disable))
...
#define IS_ETH_CHECKSUM_OFFLOAD(CMD) (((CMD) == ETH_ChecksumOffload_Enable) || ((CMD) == ETH_ChecksumOffload_Disable))
...
#define IS_ETH_DEFERRAL_CHECK(CMD) (((CMD) == ETH_DeferralCheck_Enable) || ((CMD) == ETH_DeferralCheck_Disable))
...
#define IS_ETH_PROMISCUOUS_MODE(CMD) (((CMD) == ETH_PromiscuousMode_Enable) || ((CMD) == ETH_PromiscuousMode_Disable))
...
#define IS_ETH_PAUSE_LOW_THRESHOLD(THRESHOLD)                                                                                                              \
    (((THRESHOLD) == ETH_PauseLowThreshold_Minus4) || ((THRESHOLD) == ETH_PauseLowThreshold_Minus28) || ((THRESHOLD) == ETH_PauseLowThreshold_Minus144) || \
...
#define IS_ETH_DMA_TXDESC_SEGMENT(SEGMENT) (((SEGMENT) == ETH_DMATxDesc_LastSegment) || ((SEGMENT) == ETH_DMATxDesc_FirstSegment))
...
#define IS_ETH_DMAPTPRxDESC_GET_EXTENDED_FLAG(FLAG)                                                                                                          \
    (((FLAG) == ETH_DMAPTPRxDesc_PTPV) || ((FLAG) == ETH_DMAPTPRxDesc_PTPFT) || ((FLAG) == ETH_DMAPTPRxDesc_PTPMT) || ((FLAG) == ETH_DMAPTPRxDesc_IPV6PR) || \
     ((FLAG) == ETH_DMAPTPRxDesc_IPV4PR) || ((FLAG) == ETH_DMAPTPRxDesc_IPCB) || ((FLAG) == ETH_DMAPTPRxDesc_IPPE) || ((FLAG) == ETH_DMAPTPRxDesc_IPHE) ||   \
...
#define IS_ETH_FORWARD_UNDERSIZED_GOOD_FRAMES(CMD) (((CMD) == ETH_ForwardUndersizedGoodFrames_Enable) || ((CMD) == ETH_ForwardUndersizedGoodFrames_Disable))
...
#define IS_ETH_RECEIVE_THRESHOLD_CONTROL(THRESHOLD)                                                                  \
    (((THRESHOLD) == ETH_ReceiveThresholdControl_64Bytes) || ((THRESHOLD) == ETH_ReceiveThresholdControl_32Bytes) || \
     ((THRESHOLD) == ETH_ReceiveThresholdControl_96Bytes) || ((THRESHOLD) == ETH_ReceiveThresholdControl_128Bytes))
/**
 * @}
 */
...
#define IS_ETH_SECOND_FRAME_OPERATE(CMD) (((CMD) == ETH_SecondFrameOperate_Enable) || ((CMD) == ETH_SecondFrameOperate_Disable))
...
#define IS_ETH_RXDMA_BURST_LENGTH(LENGTH)                                                                                                                   \
    (((LENGTH) == ETH_RxDMABurstLength_1Beat) || ((LENGTH) == ETH_RxDMABurstLength_2Beat) || ((LENGTH) == ETH_RxDMABurstLength_4Beat) ||                    \
     ...
     ((LENGTH) == ETH_RxDMABurstLength_4xPBL_4Beat) || ((LENGTH) == ETH_RxDMABurstLength_4xPBL_8Beat) || ((LENGTH) == ETH_RxDMABurstLength_4xPBL_16Beat) || \
     ((LENGTH) == ETH_RxDMABurstLength_4xPBL_32Beat) || ((LENGTH) == ETH_RxDMABurstLength_4xPBL_64Beat) || ((LENGTH) == ETH_RxDMABurstLength_4xPBL_128Beat))
...
#define IS_ETH_TXDMA_BURST_LENGTH(LENGTH)                                                                                                                   \
    (((LENGTH) == ETH_TxDMABurstLength_1Beat) || ((LENGTH) == ETH_TxDMABurstLength_2Beat) || ((LENGTH) == ETH_TxDMABurstLength_4Beat) ||                    \
     ...
     ((LENGTH) == ETH_TxDMABurstLength_4xPBL_4Beat) || ((LENGTH) == ETH_TxDMABurstLength_4xPBL_8Beat) || ((LENGTH) == ETH_TxDMABurstLength_4xPBL_16Beat) || \
     ((LENGTH) == ETH_TxDMABurstLength_4xPBL_32Beat) || ((LENGTH) == ETH_TxDMABurstLength_4xPBL_64Beat) || ((LENGTH) == ETH_TxDMABurstLength_4xPBL_128Beat))
/**
...
#define IS_ETH_DMA_ARBITRATION_ROUNDROBIN_RXTX(RATIO)                                                              \
    (((RATIO) == ETH_DMAArbitration_RoundRobin_RxTx_1_1) || ((RATIO) == ETH_DMAArbitration_RoundRobin_RxTx_2_1) || \
     ((RATIO) == ETH_DMAArbitration_RoundRobin_RxTx_3_1) || ((RATIO) == ETH_DMAArbitration_RoundRobin_RxTx_4_1) || ((RATIO) == ETH_DMAArbitration_RxPriorTx))
/**
 * @}
 */
...
#define IS_ETH_DMA_GET_FLAG(FLAG)                                                                                                                       \
    (((FLAG) == ETH_DMA_FLAG_TST) || ((FLAG) == ETH_DMA_FLAG_PMT) || ((FLAG) == ETH_DMA_FLAG_MMC) || ((FLAG) == ETH_DMA_FLAG_DataTransferError) ||      \
     ((FLAG) == ETH_DMA_FLAG_ReadWriteError) || ((FLAG) == ETH_DMA_FLAG_AccessError) || ((FLAG) == ETH_DMA_FLAG_NIS) || ((FLAG) == ETH_DMA_FLAG_AIS) || \
     ((FLAG) == ETH_DMA_FLAG_ER) || ((FLAG) == ETH_DMA_FLAG_FBE) || ((FLAG) == ETH_DMA_FLAG_ET) || ((FLAG) == ETH_DMA_FLAG_RWT) ||                      \
     ((FLAG) == ETH_DMA_FLAG_RPS) || ((FLAG) == ETH_DMA_FLAG_RBU) || ((FLAG) == ETH_DMA_FLAG_R) || ((FLAG) == ETH_DMA_FLAG_TU) ||                       \
     ((FLAG) == ETH_DMA_FLAG_RO) || ((FLAG) == ETH_DMA_FLAG_TJT) || ((FLAG) == ETH_DMA_FLAG_TBU) || ((FLAG) == ETH_DMA_FLAG_TPS) ||                     \
     ((FLAG) == ETH_DMA_FLAG_T))
/**
 * @}
 */
...
#define IS_ETH_MMC_GET_IT(IT)                                                                                                                           \
    (((IT) == ETH_MMC_IT_TGF) || ((IT) == ETH_MMC_IT_TGFMSC) || ((IT) == ETH_MMC_IT_TGFSC) || ((IT) == ETH_MMC_IT_RGUF) || ((IT) == ETH_MMC_IT_RFAE) || \
     ((IT) == ETH_MMC_IT_RFCE))
/**
 * @}
 */
...
#define IS_ETH_MMC_REGISTER(REG)                                                                                                                   \
    (((REG) == ETH_MMCCR) || ((REG) == ETH_MMCRIR) || ((REG) == ETH_MMCTIR) || ((REG) == ETH_MMCRIMR) || ((REG) == ETH_MMCTIMR) ||                 \
     ((REG) == ETH_MMCTGFSCCR) || ((REG) == ETH_MMCTGFMSCCR) || ((REG) == ETH_MMCTGFCR) || ((REG) == ETH_MMCRFCECR) || ((REG) == ETH_MMCRFAECR) || \
     ((REG) == ETH_MMCRGUFCR))
...
#define IS_ETH_PTP_UPDATE(UPDATE) (((UPDATE) == ETH_PTP_FineUpdate) || ((UPDATE) == ETH_PTP_CoarseUpdate))
...
#define IS_ETH_PTP_GET_FLAG(FLAG)                                                                                                            \
    (((FLAG) == ETH_PTP_FLAG_TSARU) || ((FLAG) == ETH_PTP_FLAG_TSITE) || ((FLAG) == ETH_PTP_FLAG_TSSTU) || ((FLAG) == ETH_PTP_FLAG_TSSTI) || \
     ((FLAG) == ETH_PTP_FLAG_TSTTR) || ((FLAG) == ETH_PTP_FLAG_TSSO))
...
#define IS_ETH_PTP_TIME_SIGN(SIGN) (((SIGN) == ETH_PTP_PositiveTime) || ((SIGN) == ETH_PTP_NegativeTime))
...
#define IS_ETH_PTP_REGISTER(REG)                                                                                                        \
    (((REG) == ETH_PTPTSCR) || ((REG) == ETH_PTPSSIR) || ((REG) == ETH_PTPTSHR) || ((REG) == ETH_PTPTSLR) || ((REG) == ETH_PTPTSHUR) || \
     ((REG) == ETH_PTPTSLUR) || ((REG) == ETH_PTPTSAR) || ((REG) == ETH_PTPTTHR) || ((REG) == ETH_PTPTTLR) || ((REG) == ETH_PTPTSSR))
...
#define IS_ETH_PTP_TYPE_CLOCK(CLOCK)                                                                                              \
    (((CLOCK) == ETH_PTP_OrdinaryClock) || ((CLOCK) == ETH_PTP_BoundaryClock) || ((CLOCK) == ETH_PTP_EndToEndTransparentClock) || \
...
#define IS_ETH_PTP_SNAPSHOT(SNAPSHOT)                                                                                                               \
    (((SNAPSHOT) == ETH_PTP_SnapshotMasterMessage) || ((SNAPSHOT) == ETH_PTP_SnapshotEventMessage) || ((SNAPSHOT) == ETH_PTP_SnapshotIPV4Frames) || \
     ((SNAPSHOT) == ETH_PTP_SnapshotIPV6Frames) || ((SNAPSHOT) == ETH_PTP_SnapshotPTPOverEthernetFrames) || ((SNAPSHOT) == ETH_PTP_SnapshotAllReceivedFrames))

/** @defgroup ETHERNET_Media_Interface
 * @{
 */
#define ETH_MediaInterface_MII  ((uint32_t)0x00000000)
#define ETH_MediaInterface_RMII SYSCFG_PMC_MII_RMII_SEL

#ifndef SYSCFG_ETH_MediaInterface_MII
#define SYSCFG_ETH_MediaInterface_MII  ETH_MediaInterface_MII
#define SYSCFG_ETH_MediaInterface_RMII ETH_MediaInterface_RMII
#endif

#define IS_ETH_MEDIA_INTERFACE(INTERFACE) (((INTERFACE) == ETH_MediaInterface_MII) || ((INTERFACE) == ETH_MediaInterface_RMII))
...
uint32_t   ETH_Init(ETH_InitTypeDef* ETH_InitStruct, PHY_DescripDef* PHY_Descrip);
...
void       ETH_MediaInterfaceConfig(uint32_t ETH_MediaInterface);
#define SYSCFG_ETH_MediaInterfaceConfig ETH_MediaInterfaceConfig
